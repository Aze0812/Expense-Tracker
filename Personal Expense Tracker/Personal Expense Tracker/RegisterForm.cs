...
namespace Personal_Expense_Tracker
{
    ...
    {
        // DATABASE NI ZEJI
        SqlConnection dbZ = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\Zeji\Documents\XpenseDB.mdf;Integrated Security=True;Connect Timeout=30");
            ...
            else
            {
                if (checkConnection())
                {
                    try
                    {
                        ...
                        string SelectUser = "SELECT * FROM ExpenseUser WHERE username = @usern";
                        ...
                        using (SqlCommand CheckingUser = new SqlCommand(SelectUser, dbZ))
                        {
                            ...
                            else
                            {
                                ...
                                string InsertingData = "INSERT INTO ExpenseUser(username, password, date_create) VALUES (@usern, @pass, @date)";
